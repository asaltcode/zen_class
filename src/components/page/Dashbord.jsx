        ...
        <Table striped bordered hover>
            ...
            <tbody className="tableBody">
                ...
                <tr  className="text-center" key={e._id} >
                    ...
                    <td><Button onClick={()=> navigate(`/student-list/${e._id}`)} variant="warning">View Student</Button></td>
                    <td>
                        <Button onClick={()=> navigate(`/edit/${e._id}`)} variant="info"><LiaUserEditSolid/></Button>{" "}
                        &nbsp;
